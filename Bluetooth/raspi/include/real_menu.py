...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.editProtocolButton.setGeometry(QtCore.QRect(270, 370, 75, 23))
        self.editProtocolButton.setObjectName("editProtocolButton")
        self.connectBluetooth = QtWidgets.QPushButton(self.page)
        self.connectBluetooth.setGeometry(QtCore.QRect(270, 390, 75, 23))
        ...
        self.errorLabel.setGeometry(QtCore.QRect(295, 260, 47, 14))
        ...
        self.tempButton.clicked.connect(self.goGraph)
        ...
        self.yAmplitudeButton.clicked.connect(self.goGraph)
        self.zAmplitudeButton.clicked.connect(self.goGraph)
        self.xFreqButton.clicked.connect(self.goGraph)
        self.yFreqButton.clicked.connect(self.goGraph)
        self.zFreqButton.clicked.connect(self.goGraph)
        self.humButton.clicked.connect(self.goGraph)
        self.presButton.clicked.connect(self.goGraph)
